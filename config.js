...
const spotCheckOnlyThreshold = 1000; // The 75th percentile cuttoff for node response time (last week) that excludes nodes from handling single requests (milliseconds)
